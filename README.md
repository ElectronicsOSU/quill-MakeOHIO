...
In an effort to provide a better hackathon experience, [OHI/O](https://github.com/hackohio) (The Ohio State University's hackathon program) and the [Electronics Club](https://github.com/electronicsosu) tried something new for MakeOHI/O 2018. Thanks to the brilliant and generous students of TechX at MIT, we adapted their open-source hackathon registration web application by forking the project to add our own features, improvements, and customizations. More details about Quill, from its original readme, are below. Our webserver for registration is located at [https://make.osu.edu/register/](https://make.osu.edu/register/), hosted on a Digital Ocean Droplet (VPS) running Debian Linux. Anyone is welcome to make a pull request. Happy hacking!
